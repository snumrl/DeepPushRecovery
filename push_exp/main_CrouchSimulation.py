...
def simulate(sim, launch_order, num=100, option_str='', trial_force=None):
    ...
    stride_vars = [0.0323409929, 0.02508595114, 0.02772452640, 0.02817863267]
    stride_speed_covars = [0.0377988437, 0.02225320798, 0.02906793442, 0.03000639027]
    speed_vars = [0.0692930964, 0.04421889347, 0.04899931048, 0.05194827755]
