...
def simulate(sim, launch_order, num=1000, option_str='', trial_force=None, std_ratio=0.):
    #=======================================================================
    # settings
    #=======================================================================
    ...
    if TEST:
        ...
        if trial_force is None:
            additional_str = '_{deg}deg__push_{std:.1f}std'.format(deg=mean_crouch[0], std=std_ratio)
        else:
    ...
    if trial_force is None:
        ...
        mean_length_ratio += std_ratio * std_length_ratio
        mean_speed_ratio += std_ratio * std_speed_ratio
